...
class _ChatRoomScreenState extends State<ChatRoomScreen> {
  ...
  Future<void> _sendMessage() async {
    ...
    final replyText = _replyingTo?.type == 'text' ? _replyingTo?.text : (_replyingTo?.type == 'image' ? 'Image' : 'Media');
              ...
              child: Consumer2<ChatProvider, CoupleProvider>(
                builder: (_, chat, couple, __) {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (_, i) => SwipeTo(
                      onRightSwipe: (details) {
                        setState(() {
                          _replyingTo = chat.messages[i];
                          _focusNode.requestFocus();
                        });
                      },
                      child: _buildMessage(chat.messages[i]),
                    ),
                  );
                },
              ),
          ...
          children: [
            if (message.replyToId != null)
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border(left: BorderSide(color: ThemeConstants.primaryColor, width: 4)),
                ),
                child: Text(
            ...
            if (message.type == 'image' && message.imagePath != null)
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    const SizedBox(width: 8),
                    Text('${message.voiceDuration ?? 0}s',
              ...
              Padding(
                ...
                child: Text(message.emoji ?? '❤️', style: const TextStyle(fontSize: 48)),
              )
            else
              Container(
            ...
            Padding(
              ...
              child: Text(
                DateFormatUtils.timeAgo(DateFormatUtils.parseDateTime(message.createdAt)),
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      const Text('Replying to message', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12)),
                      Text(
